...
func lenEncInt(_ b: [UInt8]) -> (UInt64?, Int) {
    ...
    case 0xfe:
        let p0 = UInt64(b[1])
        let p1 = UInt64(b[2]) << 8
        let p2 = UInt64(b[3]) << 16
        let p3 = UInt64(b[4]) << 24
        let p4 = UInt64(b[5]) << 32
        let p5 = UInt64(b[6]) << 40
        let p6 = UInt64(b[7]) << 48
        let p7 = UInt64(b[8]) << 56
        
        return (p0 | p1 | p2 | p3 | p4 | p5 | p6 | p7, 9)
    default:
        break
    }
